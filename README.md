...
**Управленческий дашборд для контроля эффективности отдела снабжения**

### Метрики верхнего уровня (5 ключевых показателей)
- **Всего заявок** — с динамикой за неделю
- **В работе** — процент от общего числа
- **Эффективность** — процент закрытых в срок
- **Просрочено** — 🟢/🟡/🔴 индикаторы состояния
- **Счета на согласовании** — ⚠️ выделение просроченных >7 дней

### Вкладки

1. **👥 По ответственным** — главная вкладка для руководителя
   - Таблица с цветовой индикацией эффективности:
     - 🟢 ≥90% — отлично
     - 🟡 75-90% — хорошо
     - 🔴 <75% — требует внимания
   - Красная подсветка сотрудников с просрочками
   - Детализация по выбранному сотруднику:
     - 4 ключевые метрики
     - Список всех заявок с проектами
     - Счётчик заявок в каждом проекте
   - График распределения нагрузки (топ-10)

2. **📊 По проектам**
   - Группировка заявок по проектам
   - Количество ответственных на проекте
   - Процент закрытия в срок
   - Детализация проекта:
     - Список ответственных
     - Статистика по каждому сотруднику в проекте
   - График статусов (топ-10)
...
3. **💰 Счета на оплату**
   - Счета на согласовании с цветовой индикацией:
     ...
     - 🟡 3-7 дней — внимание
     - 🔴 > 7 дней — критично
   - Метрики: всего, просроченные, общая сумма

4. **🚚 Доставки**
   - Запланированные доставки
   - Разбивка: сегодня / на неделе / всего

5. **📈 Эффективность** — аналитика для принятия решений
   - **🎯 Ключевые показатели** (5 KPI отдела):
     - Общая эффективность
     - Скорость закрытия
     - % просрочек в работе
   ...
   - **⚠️ Требуют внимания**:
     - Топ-5 сотрудников с просрочками
     - Проекты с эффективностью <75%
   - **📅 Динамика создания заявок** — график по неделям
   - **🏆 Рейтинг эффективности**:
     - Лучшие сотрудники (>90% в срок)
...
### Telegram Mini App
- Доступ к дашборду через Telegram бота
- Авторизация по белому списку пользователей
- Полный функционал Streamlit в мессенджере
- См. [QUICKSTART_TELEGRAM.md](QUICKSTART_TELEGRAM.md)
